...
# === SHARED CHART STYLE ===
bg_color = "#FFF3CF"  # light pastel from logo
...
with col6:
    fig3 = px.pie(segment_counts, names="Customer Type", values="Count", hole=0.4, title="Customer Segmentation", color_discrete_sequence=px.colors.sequential.Oranges)
